...
impl Default for ControlPointsCurveProperties {
    fn default() -> Self {
        Self {
            ...
            control_line: VisualLine::new(VisualLineProperties::new(false, false, 4.0, Rgb::WHITE)),
            convex_hull: VisualLine::new(VisualLineProperties::new(false, false, 4.0, Rgb::WHITE)),
